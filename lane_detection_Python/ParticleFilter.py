...
__init__(self, N, x_range, x_initial,sensor_err, par_std):
...
class ParticleFilter:
    def __init__(self, N, x_range, x_initial,sensor_err, par_std):
        self.N = N
    ...
    def create_gaussian_particles(self):
        ...
        self.particles[:, 0] = self.x_initial + (randn(self.N) * self.particle_std)
